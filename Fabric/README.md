...
<i>__Fabric__(https://www.fabfile.org/, https://github.com/euiyounghwang/python-DevOps) is a high level Python (2.7, 3.4+) library designed to execute shell commands remotely over SSH, yielding useful Python objects in return. 
